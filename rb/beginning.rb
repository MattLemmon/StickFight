...
#    @count = 1    
    ...
    @t2 = Chingu::Text.create("Left Player", :y => 300, :font => "GeosansBold", :size => 52, :zorder => Zorder::GUI)
...
class Intro < Chingu::GameState
  ...
  def setup
    ...
    after(600) {
      ...
      @ready1 = false
      @caption1 = Chingu::Text.create("#{$image1}", :y => @player1_select.y - 150, :size => 45, :zorder => Zorder::GUI)
    ...
    after(900) {
      ...
      @caption2 = Chingu::Text.create("#{$image2}", :y => @player2_select.y - 150, :size => 45, :zorder => Zorder::GUI)
      @caption2.x = @player2_select.x - @caption2.width/2 # center text
    }

    after(1200) {
      @text3 = Chingu::Text.create("Health", :y => 300, :size => 32, :zorder => Zorder::GUI)
      @text3.x = 714 - @text3.width/2 # center text
      @text3_5 = Chingu::Text.create( $health1.to_s, :y => 270, :size => 40, :zorder => Zorder::GUI)
      @text3_5.x = 714 - @text3_5.width/2 # center text
    }
    after(1500) {
      @text4 = Chingu::Text.create("#{@health2_text1}", :y => 300, :size => 32, :zorder => Zorder::GUI)
      @text4.x = 107 - @text4.width/2 # center text
      @text4_5 = Chingu::Text.create("#{@health2_text2}", :y => 270, :size => 40, :zorder => Zorder::GUI)
      @text4_5.x = 107 - @text4_5.width/2 # center text
    }
    after(1800) {
      @text1 = Chingu::Text.create("Right Shift", :y => 420, :size => 32, :zorder => Zorder::GUI)
      @text1.x = 614 - @text1.width/2 # center text
      @text1_5 = Chingu::Text.create("to Select", :y => 452, :size => 32, :zorder => Zorder::GUI)
      @text1_5.x = 614 - @text1_5.width/2 # center text
    }
    after(2100) {
      if $mode == "Versus"
        @text2 = Chingu::Text.create("Left Shift", :y => 420, :size => 32, :zorder => Zorder::GUI)
        @text2.x = 207 - @text2.width/2 # center text
        @text2_5 = Chingu::Text.create("to Select", :y => 452, :size => 32, :zorder => Zorder::GUI)
...
#      $guitar_riff.play(0.4) }
    after(1500) {
      @text3 = Chingu::Text.create("#{@chant}", :y => 50, :size => 60, :zorder => Zorder::GUI)
